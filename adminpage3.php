<?php 
    ...
    if (isset($_POST['submit'])) {
        $type=$_POST['type'];
        $query = "INSERT INTO type (name_type)
                        VALUE ('$type')";
        $result = mysqli_query($conn, $query);
        if ($result){
            echo "<script>";
                echo "alert('เพิ่ม Type เรียบร้อย');";
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Update Type</h5>
                            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    <form action="updatetypedb.php" method="POST" id="updatetype">
            ...
            function form_submit() {
                document.getElementById("updatetype").submit();
            }    
            </script>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" style="padding-top:10px;margin-left:2%;">
                            <label for="textcategory">Add Type</label>
                            <br>
                            <input type="text" id="type" name="type" style="">
                        ...
                        <div class="container">
                            ...
                            <table style="margin-left:5%;" id="" class="table table-bordered w-auto">
                                ...
                                <tbody>
                                    <?php
                                        $result=mysqli_query($conn,"SELECT * FROM type ORDER BY id_type ASC");
                                        if($result){
                                            while($row=mysqli_fetch_assoc($result)){
                                                ...
                                                <td>'.$type.'</td>
                                                <td>
                                                <a href="#"><button class="btn btn-primary btn-sm updatebtn" type="submit" id="'.$id_type.'" >Update</button></a>
                                                <a href="deletetypedb.php?id='.$id_type.'" onclick="return checkDelete()"><button class="btn btn-danger btn-sm" type="submit">Delete</button></a>
                                                </td>
                                                </tr>';
                                            }
                                        }
