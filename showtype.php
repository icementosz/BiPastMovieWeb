  ...
  <div class="main-content">
    ...
    <section id="iq-favorites">
      <div class="container-fluid">
        ...
        ?>    
          <h5>หนัง<?=$resulttype['name_type']?></h5>
        <?php ?> 
        <div class="row">
          <div class="col-sm-12 overflow-hidden">
            <div class="favorite-contens">
              <ul class="favorites-slider list-inline row p-0 mb-0">
                <!-- slide item -->
                <?php 
                    $query = mysqli_query($conn,"SELECT data_movie.*,nameandtype.* FROM data_movie,nameandtype WHERE
                    data_movie.id=nameandtype.id_movie AND nameandtype.id_type=$id_type");
