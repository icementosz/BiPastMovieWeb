            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container">
                            <br>
                            <a href="addmovie.php"><button class="btn btn-success my-1" type="submit">Add Movie</button></a>
                            ...
                            <table id="datatableuser" class="table" style="width: 100%;">
                            <colgroup>
                                    <col width="25%">
                                    <col width="15%">
                                    <col width="20%">
                                ...
                                <tbody>
                                    <?php
                                        $result=mysqli_query($conn,"SELECT * FROM data_movie ORDER BY id ASC");
                                        if($result){
                                            while($row=mysqli_fetch_assoc($result)){
                                                ...
                                                <td>'.$totallikes.'</td>
                                                <td>
                                                <a href="updatemovie.php?id='.$id.'"><button class="btn btn-primary btn-sm" type="submit">Update</button></a>
                                                <a href="deletemoviedb.php?id='.$id.'" onclick="return checkDelete()"><button class="btn btn-danger btn-sm" type="submit">Delete</button></a>
                                                </td>
                                                </tr>';
                                            }
                                        }
